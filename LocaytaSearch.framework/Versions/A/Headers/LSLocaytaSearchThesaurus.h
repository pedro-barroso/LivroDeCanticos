 ...
 *
 * @param aDatabasePath an existing search database directory.
 */
 ...
 *
 * @param synonyms an NSDictionary keyed by term (NSString) with an NSArray
 ...
 *
 * @param synonymsArray an NSArray of NSArrays of the form
 * ("term", "syn1", "syn2", ...).
 *
 * Performs the same function as \ref addSynonyms: with the convenience of
