 ...
 * values must be stored in either a "text slot" (for case-insensitive sorting),
 * a "numeric slot" (for numeric sorting), or a "string slot" (for sorting string literals),
 * by specifying either "textslot", "numericslot", or "stringslot"
 ...
 *
 * This is a convenience method for \code [searchRequest searchWithQuery:searchQuery topDocIndex:0 docsPerPage:10 facets:nil] \endcode
 */
 ...
 *
 * This is a convenience method for \code [searchRequest searchWithQuery:searchQuery topDocIndex:topDocIndex docsPerPage:docsPerPage facets:nil]; \endcode
 */
- (void)searchWithQuery:(LSLocaytaSearchQuery *)query topDocIndex:(NSInteger)topDocIndex docsPerPage:(NSInteger)docsPerPage;

/**
 * \brief Performs a search request asynchronously, requesting a specified range of results and optionally collecting facet data.
 *
 ...
 *                 topDocIndex:40
 *                 docsPerPage:20
 *                 facets:[NSArray arrayWithObjects:@"colour", [NSNumber numberWithInt:1], nil]];
 *  [searchRequest release];
 *
 * \endcode
 */
- (void)searchWithQuery:(LSLocaytaSearchQuery *)query topDocIndex:(NSInteger)topDocIndex docsPerPage:(NSInteger)docsPerPage facets:(NSArray*)facets;
...
/**
 * \brief       Block until the current search request has completed.
 */
- (void)waitUntilRequestIsFinished;
 ...
 *
 * @param searchRequest the LSLocaytaSearchRequest object performing the request
 ...
 *
 * @param searchRequest the LSLocaytaSearchRequest object performing the request
 * @param searchResult details of the failure
 */
